<template>
  <q-page class="row items-center justify-evenly">
    <q-form class="q-gutter-md" @submit="submit">
      <q-card bordered>
        <q-card-section>
          <i alt="" class="h-32 w-32 block mx-auto i-logos-feathersjs" />
          <div class="text-h2 text-bold">Feathers Chat</div>
        </q-card-section>
